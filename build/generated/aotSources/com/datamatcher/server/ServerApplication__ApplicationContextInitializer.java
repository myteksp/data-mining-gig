 ...
 */
@Generated
public class ServerApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new ServerApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new ServerApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
