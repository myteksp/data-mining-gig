...
import com.datamatcher.server.ServerApplicationTests__TestContext001_ApplicationContextInitializer;
...
public class AotTestContextInitializers__Generated {
  public static Map<String, Supplier<ApplicationContextInitializer<? extends ConfigurableApplicationContext>>> getContextInitializers(
    ...
    map.put("com.datamatcher.server.ServerApplicationTests", () -> new ServerApplicationTests__TestContext001_ApplicationContextInitializer());
    return map;
  }
  ...
  public static Map<String, Class<? extends ApplicationContextInitializer<?>>> getContextInitializerClasses(
    ...
    map.put("com.datamatcher.server.ServerApplicationTests", ServerApplicationTests__TestContext001_ApplicationContextInitializer.class);
    return map;
  }
}
